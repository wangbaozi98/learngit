                ...
                <div class="row">
                    ...
                    <div class="col-md-12 center-block" style="float: none;">
                        ...
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="supp_add">
                                <div class="box-body">
                                    <div class="form-group required">
                                        <label for="inputEmail3" class="col-sm-2 control-label">mcid</label>

                                        <div class="col-sm-4">
                                            <input type="text" name="supp_mcid" class="form-control" id="inputEmail3" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label for="inputPassword3" class="col-sm-2 control-label">标准名</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="supp_name" class="form-control" id="inputPassword3" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="supp_name_cn" class="form-control" id="exampleInputEmail1" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1" class="col-sm-2 control-label">英文名</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="supp_name_en" class="form-control" id="exampleInputPassword1" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="supp_region" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="supp_homepage" class="form-control" id="exampleInputEmail1" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label for="exampleInputPassword1" class="col-sm-2 control-label">佣金</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="supp_aff_min" class="form-control" id="exampleInputPassword1" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea name="supp_desc_cn" class="form-control" rows="3" placeholder=""></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea name="supp_desc_en" class="form-control" rows="3" placeholder=""></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 file-loading">
                                            ...
                                            <input type="hidden" id="supp_logo" name="supp_logo" value="" class="input-max" ccept="image/png,image/jpg,image/jpeg,image/gif">
                                            <div id="img_div">
                                                <img id="goods_img" src="" width="200"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-footer">
                                    <button type="button" class="btn btn-info col-lg-offset-2" id="submit_btn" onclick="suppAdd()">提交</button><br/><br/><br/><br/>
                                </div>
                            </form>
